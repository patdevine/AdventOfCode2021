...
public class SevenSegmentSearchPart1 {
    ...
    public static void main(String[] args) {
        int totalCount = Arrays.stream(input.split("\n")).map(SevenSegmentSearchPart1::displayCount).mapToInt(Integer::intValue).reduce(0, (count, current) -> count + current);
